               ...
               {loading ? (
                    ...
                    <div className='searchbox flex flex-col items-center  gap-2 rounded-2xl bg-opacity-40 shadow-xl  text-onsecondary  drop-shadow-lg backdrop-blur-lg w-min mx-auto my-3 p-4  '>
                         ...
                         <form className=" m-auto p-2 rounded-xl" onSubmit={work}>
                              ...
                              <select id="number" name='number' className=" w-44 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary focus:border-primary block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                   {data.numbers.map((option, index) => (
